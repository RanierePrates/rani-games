...
{{--                    <img src="" alt="" class="w-32 flex-none">--}}
            ...
            <div class="flex items-center">
                <div class="relative">
                    <input type="text" name="" id="" class="bg-gray-800 focus:outline-none focus:shadow-outline text-sm
                    rounded-full w-64 px-3 pl-8 py-1" placeholder="Search...">
    ...
    <footer class="border-t border-gray-800">
        <div class="container mx-auto px-4 py-6">
            Power By <a href="#" class="underline hover:text-gray-400">IGBD API</a>
        </div>
    </footer>
</body>
</html>
