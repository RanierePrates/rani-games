        ...
        <div class="popular-games text-sm grid grid-cols-6 gap-12 border-b border-gray-800 pb-16">
            <div class="game mt-8">
                <div class="relative inline-block">
                    <a href="#">
                        <img src="/images/ff7.jpg" alt="game cover" class="w-20 lg:w-48 hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                ...
                <div class="most-antecipated-container space-y-10 mt-8">
                    <div class="game flex">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-gray-400 text-sm mt-1">Spt 16, 2020</div>
                        </div>
                    </div>
                </div>
            </div>
